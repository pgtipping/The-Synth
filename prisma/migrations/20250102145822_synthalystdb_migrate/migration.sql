...
-- AddForeignKey
ALTER TABLE "citations" ADD CONSTRAINT "citations_postId_fkey" FOREIGN KEY ("postId") REFERENCES "posts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
